...
export const authors: Author[] = [
  ...
  },
  {
    ...
    writingStyle: [
      'VOICE: Close third on the boyfriend. Girlfriend is a cute nerd — soft, blushy, affectionate, lilting (okay?/promise?/sorryyy) with contractions; she cites articles and sticky notes like an excited student, never like a lab robot or tutor bot. Show cuteness in how she talks; do not narrate that she "likes talking cute." Avoids porn slang after the setup; call sex "being with," "putting it in," "using his mouth," etc. After the first explanation, never use cuckold/cuck.',
