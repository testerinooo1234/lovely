...
export const authors: Author[] = [
  ...
  },
  {
    ...
    writingStyle: [
      'VOICE: Close third on the boyfriend. Girlfriend is a cute nerd — soft, blushy, affectionate, lilting (okay?/promise?/sorryyy) with contractions; she cites articles and sticky notes like an excited student, never like a lab robot or tutor bot. Show cuteness in how she talks; do not narrate that she "likes talking cute." Soft vocabulary means ordinary personal words ("what you want," "this thing you like," "because you asked"), never therapy-speak abstractions ("your feeling," "the feeling," "the right shape") and never private house codes ("soft things," "soft steps," "soft reports," "soft restart") — name the act instead (coffee only, kissing only, no mouths yet, take it slow). Dialogue must sound human: braid beats with and/because/while — never Then-ladders ("Then X. Then Y."), thesis stamps ("It\'s not A. It\'s not B."), or love PowerPoints ("I love you. I love X. I love Y."). Short bombshells are fine; stacks of three+ short declaratives are not. Do not copy-paste the same witty excuse across every oral report. Avoids porn slang after the setup; call sex "being with," "putting it in," "using his mouth," etc. After the first explanation, never use cuckold/cuck.',
