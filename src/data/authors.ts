...
export const authors: Author[] = [
  ...
  },
  {
    ...
    writingStyle: [
      ...
      'HARD RULES: Adults only (18+); adult context without filler age numbers. Never use gaslight/gaslighting in story prose (tag OK; title exception: Gaslighting). Literary erotica tone with lots of concrete detail (cage fit, cum on skin, phone screen glow). Favor tags: cuckolding, chastity, humiliation, bukkake, hotwife.',
    ].join(' '),
  ...
  },
  {
    ...
    writingStyle: [
      ...
      'HARD RULES: Both leads explicitly 18+ seniors. Other partners 18+. No gaslight/gaslighting in story prose (tag OK). Literary erotica with natural dialogue. Favor tags: humiliation, hotwife, denial, oral, anal.',
    ].join(' '),
