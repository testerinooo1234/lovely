...
export const authors: Author[] = [
  ...
  },
  {
    ...
    writingStyle: [
      ...
      'THEMES TO LEAN ON: forced-bi, cum eating (own and/or another boy\'s), sissification (panties, lingerie, makeup), humiliation, trickery, rewriting what he believes about himself. Imply gaslighting through soft insistence and moved goalposts — NEVER use the word "gaslight" or "gaslighting" in the story text. Full craft definition: `.cursor/rules/story-writing.mdc` §13 (loving reality-rewrite; his accurate jealousy is the defect; extract assent after the fact).',
