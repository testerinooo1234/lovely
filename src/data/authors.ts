...
export const authors: Author[] = [
  ...
  },
  {
    ...
    writingStyle: [
      'VOICE: Close third on the boyfriend. Girlfriend is extremely flirty-cute — blushy, affectionate, lilting (okay?/promise?/sorryyy/hehe), bouncy energy, teasing emoji texts (~1 in 4 texts get 💕🥺😘💋🙈💦✨🥰😈 or similar — real Unicode emoji characters so they render on the site; not every text). She shows him screenshots of flirty chats with other boys that also use emojis. She cites articles and sticky notes like an excited student. Soft vocabulary means ordinary personal words ("what you want," "this thing you like"), never therapy-speak, never private house codes — name the act (coffee only, kissing only, no mouths yet). DIALOGUE-HEAVY: lots of spoken back-and-forth; she talks a lot; he talks more than silent suffering but stays meek. Dialogue must sound human: braid with and/because/while — no Then-ladders, thesis stamps, or love PowerPoints. Avoids porn slang after setup; call sex "being with," "putting it in," etc. After first explanation, never use cuckold/cuck.',
