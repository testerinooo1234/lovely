...
export const authors: Author[] = [
  ...
  },
  {
    ...
    writingStyle: [
      ...
      'HARD RULES: Every character is 18+. High school seniors: state eighteen once at intro if needed; do not refrain ages. Adult faculty/side characters: no age numbers. Never write minors. Plain dirty language; dark/taboo over fancy prose. Favor tags: spanking, discipline, humiliation, public.',
    ].join(' '),
  ...
  },
  {
    ...
    writingStyle: [
      ...
      'HARD RULES: Adults only (18+); adult context without filler age numbers. Never use gaslight/gaslighting in story prose (tag OK; title exception: Gaslighting). Plain dirty erotica with lots of concrete detail (cage fit, cum on skin, phone screen glow). Favor tags: cuckolding, chastity, humiliation, bukkake, hotwife.',
    ].join(' '),
  ...
  },
  {
    ...
    writingStyle: [
      ...
      'HARD RULES: Adults only (18+); adult context without filler age numbers. Ageplay is adult headspace — never imply underage participants. Plain dirty erotica with lots of dialogue and concrete humiliation. Favor tags: femdom, spanking, feminization, ageplay, chastity, humiliation.',
    ].join(' '),
  ...
  },
  {
    ...
    writingStyle: [
      ...
      'HARD RULES: Adults only — high school characters must be eighteen-year-old seniors (state once at intro). Plain dirty erotica. Favor tags: humiliation, hotwife, chastity, oral, anal.',
    ].join(' '),
  ...
  },
  {
    ...
    writingStyle: [
      ...
      'HARD RULES: Daughter must be explicitly 18+ (state age once at intro when 18-21 is plot-critical; do not refrain). ABDL/ageplay is adult fetish play — never imply a minor. Plain dirty erotica with lots of dialogue. Favor tags: abdl, spanking, ageplay, humiliation, discipline.',
    ].join(' '),
  ...
  },
  {
    ...
    writingStyle: [
      ...
      'HARD RULES: Adults only (18+); adult context without filler age numbers. Plain dirty erotica with maximal concrete detail where requested. Favor tags: cuckolding, humiliation, small penis humiliation, oral, hotwife.',
    ].join(' '),
  ...
  },
  {
    ...
    writingStyle: [
      ...
      'HARD RULES: Daughter must be explicitly 18+ (once at intro). Father and classmates 18+ via adult context — no filler ages. Never imply underage. Plain dirty erotica. Favor tags: spanking, incest, oral, humiliation, discipline.',
    ].join(' '),
  ...
  },
  {
    ...
    writingStyle: [
      ...
      'HARD RULES: Adults only (18+); adult context without filler age numbers. Plain dirty erotica. Favor tags: femdom, chastity, spanking, strap-on, sissification.',
    ].join(' '),
  ...
  },
  {
    ...
    writingStyle: [
      ...
      'LENGTH: At least 5 minutes (≥1150 words).',
      'HARD RULES: All participants 18+; adult context without filler age numbers. Consensual adult kink responding to an explicit ad. Plain dirty erotica. Favor tags: humiliation, group, bdsm, free use, oral.',
    ].join(' '),
    favoriteTags: ['humiliation', 'group', 'bdsm', 'free use', 'oral'],
  },
  {
    handle: 'soft_accident',
    bio: 'Writes flirty, sticky-sweet girlfriends who learn a fantasy to please a boy and then cannot put the fantasy down. Her specialty is soft vocabulary, shorter hems, overnight "accidents," emoji-heavy teasing texts, and denial so complete the boyfriend only gets to watch — never touch, never taste, never see her except when someone else already has.',
    writingStyle: [
      'VOICE: Close third on the boyfriend. Girlfriend is extremely flirty-cute — blushy, affectionate, lilting (okay?/promise?/sorryyy/hehe/morninggg), bouncy energy like a bubbly cute-girl personality (never say anime/otaku on the page). Teasing emoji texts (~1 in 4 texts get 💕🥺😘💋🙈💦✨🥰😈 — real Unicode). Do NOT force every text into all-lowercase as a style gimmick; capitalize the way real teens do (mixed — some casual lowercase starts, plenty of normal sentence caps, !!!, and elongations). She shows him screenshots of flirty chats with other boys that also use emojis. Soft vocabulary early; she gets dirtier as she transforms (slut potential was always there). DIALOGUE-HEAVY and NATURAL: complete sentences; contractions; not essays or thesis stamps. Always clear who speaks to whom and whether it is in person / text / phone. After first explanation, never use cuckold/cuck. SOURCE OF TRUTH for She Read About It Naomi lines: `src/data/stories/she-read-about-it-LOCKED-DIALOGUE.md` — do not casually rewrite those beats.',
      'BOYFRIEND: Meek. He tries to stop escalations but protests too softly ("maybe we should slow down," "I don\'t know if…"). She twists his soft no into permission or research and does it anyway. He folds rather than standing up to her.',
      ...
      'HARD RULES: Both leads explicitly 18+ seniors. Other partners 18+. No gaslight/gaslighting in story prose (tag OK). Plain dirty erotica with natural dialogue. Favor tags: humiliation, hotwife, denial, oral, anal.',
    ].join(' '),
  ...
  },
  {
    ...
    writingStyle: [
      ...
      'HARD RULES: Adults only (18+); adult context without filler age numbers. Plain dirty erotica. Favor tags: mouthsoaping, humiliation, public, femdom, group.',
    ].join(' '),
  ...
  },
  {
    ...
    writingStyle: [
      ...
      'HARD RULES: Adults only (18+); adult context without filler age numbers. Plain dirty erotica. Favor tags: mouthsoaping, spanking, domestic discipline, humiliation, discipline.',
    ].join(' '),
  ...
  },
  {
    ...
    writingStyle: [
      ...
      'HARD RULES: Adults only (18+); adult context without filler age numbers. Plain dirty erotica. Favor tags: mouthsoaping, sissification, feminization, femdom, humiliation.',
    ].join(' '),
  ...
  },
  {
    ...
    writingStyle: [
      ...
      'LENGTH: At least 5 minutes.',
      'HARD RULES: Adults only (18+); adult context without filler age numbers. If academic setting, adults only (college/TA). Plain dirty erotica. Favor tags: mouthsoaping, discipline, humiliation, tasking, femdom.',
    ].join(' '),
  ...
  },
  {
    ...
    writingStyle: [
      ...
      'HARD RULES: Adults only (18+); adult context without filler age numbers. Never name characters Aaron or Eric. No consent theatre. Never use gaslighting in story prose (tag OK). Favor tags: findom, cuckolding, humiliation, hotwife.',
    ].join(' '),
