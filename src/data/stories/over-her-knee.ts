...
const story: Story = {
  ...
  pages: [
    [
      ...
      `"Still okay?" she asked, voice softer now under the steel, thumb stroking the edge of a blooming handprint.`,
      `"Still okay," he croaked. "Please — still okay. Don't stop because I'm crying. Stop when you're done."`,
