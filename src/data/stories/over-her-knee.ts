...
const story: Story = {
  ...
  pages: [
    [
      ...
      `They'd talked about spanking as discipline for months before the first real session — what it meant when it wasn't just dirty talk in bed. Claire had been clear: if he wanted structure, she would give it, and she wouldn't half-ass it. Daniel had nodded like an idiot in love. Tonight he was remembering that nod with his whole nervous system.`,
      `"Belt," she said.`,
