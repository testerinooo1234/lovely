...
- **No obscure house jargon / worn-out stock phrases:** do not mint private codes (`soft things`, `soft steps`, `soft reports`, `soft restart`) that mean “take it slow” without saying so. Name the act (coffee only, kissing only, no mouths yet). Do not copy-paste the same witty excuse or metaphor across every escalation beat — vary with clearer meaning or cut. Intentional cutting nicknames (`soft boy`) are fine. See `.cursor/rules/story-writing.mdc` §10.
